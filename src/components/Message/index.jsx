...
const Notice = ({duration, type, id, onClose, children, style}) => {
    duration = duration || 2;
    useEffect(() => {
...
export class Notification extends PureComponent {
    ...
    render() {
        ...
        return (
            ...
            >
                {
                    (item) => (props) => <Notice style={props} type={item.type} duration={item.duration} id={item.key} onClose={this.remove} >{item.msg}</Notice>
                }
            </Transition>
        );
    }
